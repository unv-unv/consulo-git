...
public class GitCheckinEnvironment implements CheckinEnvironment
{
	...
	private static void commit(Project project,
			...
			Date nextCommitAuthorDate) throws VcsException
	{
		...
		GitCheckinOptions(@NotNull final Project project, @NotNull CheckinProjectPanel panel)
		{
			...
			myAuthorField = new ComboBox(ArrayUtil.toObjectArray(list))
			{
				...
				public void addNotify()
				{
					...
					StringComboboxEditor comboboxEditor = new StringComboboxEditor(project, PlainTextFileType.INSTANCE, myAuthorField, true);
