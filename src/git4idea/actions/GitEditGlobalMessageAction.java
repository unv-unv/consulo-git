...
public class GitEditGlobalMessageAction extends DumbAwareAction
{
	...
	public void actionPerformed(AnActionEvent e)
	{
		...
		final String result = Messages.showMultilineInputDialog(project, "<html><body>Enter a broadcast message. The message will appear in the " +
				"Commit dialog for everyone who works with '" + project.getName() + "' project.<br> To remove the broadcast message just remove its " +
				"content.</body></html>", "Edit Global Message", message == null ? "" : message.message, null, null);
		if(result != null)
		{
			if(message == null)
			{
