...
public class GitBranchUtil
{
	 ...
	 */
	@Nullable
	public static GitRemoteBranch findRemoteBranchByName(@NotNull String remoteBranchName, @NotNull final String remoteName, @NotNull final Collection<GitRemoteBranch> remoteBranches)
	{
