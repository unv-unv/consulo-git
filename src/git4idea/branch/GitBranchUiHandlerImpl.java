...
public class GitBranchUiHandlerImpl implements GitBranchUiHandler
{
	...
	public boolean notifyErrorWithRollbackProposal(
			@NotNull final String title, @NotNull final String message, @NotNull final String rollbackProposal)
	{
	...
	{
		UntrackedFilesNotifier.notifyUntrackedFilesOverwrittenBy(myProject, untrackedFiles, operationName, null);
	}
			...
			@NotNull String operationName, @NotNull String rollbackProposal, @NotNull Collection<VirtualFile> untrackedFiles)
	{
		...
		final SelectFilesDialog dialog = new UntrackedFilesDialog(myProject, untrackedFiles, StringUtil.stripHtml(description, true),
				rollbackProposal);
	...
	private static class UntrackedFilesDialog extends SelectFilesDialog
	{
		...
		public UntrackedFilesDialog(
				@NotNull Project project, @NotNull Collection<VirtualFile> originalFiles, @NotNull String prompt, @NotNull String rollbackProposal)
		{
