...
class GitRejectedPushUpdateDialog extends DialogWrapper
{
			...
			boolean rebaseOverMergeProblemDetected)
	{
		...
		myAutoUpdateInFuture = new JCheckBox("<html>Remember the update method choice and <u>s</u>ilently update in future <br/>(you may change " +
	...
	private String descriptionEnding()
	{
		...
		if(myRebaseOverMergeProblemDetected)
		{
			desc += "<br/><br/>In this case <b>merge is highly recommended</b>, because there are non-pushed merge commits. " + "<br/>Rebasing them" +
					" " +
