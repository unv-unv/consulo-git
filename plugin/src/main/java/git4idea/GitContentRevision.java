...
public class GitContentRevision implements ContentRevision
{
	...
	protected GitContentRevision(@Nonnull FilePath file, @Nonnull GitRevisionNumber revision, @Nonnull Project project, @Nullable Charset charset)
	{
		myProject = project;
		myFile = file;
		myRevision = revision;
	...
	public String getContent() throws VcsException
	{
		...
		try
		{
			return ContentRevisionCache.getOrLoadAsString(myProject, myFile, myRevision, GitVcs.getKey(),
	 ...
	 * @throws com.intellij.openapi.vcs.VcsException if there is a problem with creating revision
	 */
	...
	private static ContentRevision createRevision(@Nonnull FilePath filePath, @Nullable VcsRevisionNumber revisionNumber, @Nonnull Project project)
	{
