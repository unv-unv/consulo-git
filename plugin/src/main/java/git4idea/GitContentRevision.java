...
public class GitContentRevision implements ByteBackedContentRevision {
    ...
    public byte[] getContentAsBytes() throws VcsException {
        ...
        try {
            ...
            return ContentRevisionCache.getOrLoadAsBytes(myProject, myFile, myRevision, GitVcs.getKey(), ContentRevisionCache.UniqueType.REPOSITORY_CONTENT, this::loadContent);
        }
        catch (IOException e) {
