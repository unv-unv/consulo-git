...
public class GitRebaseUtils
{
	...
	public static void abort(@NotNull Project project, @NotNull ProgressIndicator indicator)
	{
		...
		if(spec != null)
		{
			new GitAbortRebaseProcess(project, spec.getOngoingRebase(), spec.getHeadPositionsToRollback(), spec.getInitialBranchNames(), indicator, spec.getSaver()).abortWithConfirmation();
		}
		else
		{
