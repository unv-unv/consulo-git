...
public class GitRebaseUtils {
  ...
  public static void rebase(@Nonnull final Project project,
                            @Nonnull final List<GitRepository> repositories,
                            @Nonnull final GitRebaseParams params,
