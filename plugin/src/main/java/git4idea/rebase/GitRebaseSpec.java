...
public class GitRebaseSpec
{
	...
	public static GitRebaseSpec forResumeInSingleRepository(@Nonnull Project project, @Nonnull GitRepository repository, @Nonnull ProgressIndicator indicator)
	{
		...
		return new GitRebaseSpec(null, Collections.singletonMap(repository, suspended), Collections.<GitRepository, String>emptyMap(), Collections.<GitRepository, String>emptyMap(),
				newSaver(project, indicator), false);
	}
