...
public class GitHistoryUtils {
   ...
   */
  @Nullable
  public static VcsRevisionNumber getCurrentRevision(@Nonnull Project project,
  ...
  @Nullable
  public static VcsRevisionDescription getCurrentRevisionDescription(@Nonnull Project project,
                                                                     @Nonnull FilePath filePath) throws VcsException {
    filePath = getLastCommitName(project, filePath);
    GitSimpleHandler h = new GitSimpleHandler(project, GitUtil.getGitRoot(filePath), GitCommand.LOG);
    ...
    final String author = Comparing.equal(record.getAuthorName(),
                                          record.getCommitterName()) ? record.getAuthorName() : record.getAuthorName() + " (" + record.getCommitterName() + ")";
    return new VcsRevisionDescriptionImpl(new GitRevisionNumber(record.getHash(), record.getDate()),
                                          record.getDate(),
                                          author,
  ...
  public static void history(@Nonnull Project project,
    ...
    final GitLogParser logParser = new GitLogParser(project,
    ...
    final Consumer<GitLogRecord> resultAdapter = record ->
    {
      ...
      try {
        ...
        consumer.accept(new GitFileRevision(project,
                                            finalRoot,
                                            revisionPath,
                                            revision,
  ...
  @Nonnull
  public static List<? extends VcsShortCommitDetails> readMiniDetails(@Nonnull Project project,
                                                                      @Nonnull VirtualFile root,
    ...
    GitSimpleHandler h = new GitSimpleHandler(project, root, GitCommand.LOG);
    GitLogParser parser = new GitLogParser(project,
    ...
    return ContainerUtil.map(records, record ->
    {
      ...
      return factory.createShortDetails(HashImpl.build(record.getHash()),
                                        parents,
  ...
  @Nullable
  public static List<VcsCommitMetadata> readLastCommits(@Nonnull Project project,
                                                        @Nonnull VirtualFile root,
                                                        @Nonnull String... refs) throws VcsException {
    final VcsLogObjectsFactory factory = getObjectsFactoryWithDisposeCheck(project);
    if (factory == null) {
      return null;
    }
  ...
  private static void processHandlerOutputByLine(@Nonnull GitLineHandler handler,
                                                 @Nonnull GitLogParser parser,
                                                 @Nonnull Consumer<GitLogRecord> recordConsumer) throws VcsException {
  ...
  private static void processHandlerOutputByLine(@Nonnull GitLineHandler handler,
                                                 ...
                                                 int bufferSize) throws VcsException {
  ...
  @Nonnull
  private static Pair<TimedVcsCommit, Collection<VcsRef>> convert(@Nonnull GitLogRecord rec,
                                                                  @Nonnull VcsLogObjectsFactory factory,
                                                                  @Nonnull VirtualFile root) {
  ...
  @Nonnull
  private static Collection<VcsRef> parseRefs(@Nonnull Collection<String> refs,
                                              @Nonnull Hash hash,
                                              @Nonnull VcsLogObjectsFactory factory,
                                              @Nonnull VirtualFile root) {
  ...
  @Nonnull
  public static List<Pair<SHAHash, Date>> onlyHashesHistory(@Nonnull Project project,
                                                            @Nonnull FilePath path,
                                                            String... parameters) throws VcsException {
    final VirtualFile root = GitUtil.getGitRoot(path);
  ...
  @Nonnull
  public static VcsLogProvider.DetailedLogData loadMetadata(@Nonnull final Project project,
  ...
  @Nonnull
  private static GitLogParser createParserForDetails(@Nonnull GitTextHandler h,
  ...
  public static void loadDetails(@Nonnull Project project,
                                 ...
                                 @Nonnull String... parameters) throws VcsException {
    final VcsLogObjectsFactory factory = getObjectsFactoryWithDisposeCheck(project);
    if (factory == null) {
      return;
    }
  ...
  @Nonnull
  private static GitCommit createCommit(@Nonnull Project project,
                                        @Nonnull VirtualFile root,
  ...
  @Nonnull
  private static GitHeavyCommit createCommit(@Nonnull Project project,
                                             @Nullable SymbolicRefsI refs,
                                             @Nonnull VirtualFile root,
                                             @Nonnull GitLogRecord record) throws VcsException {
    ...
    GitHeavyCommit gitCommit = new GitHeavyCommit(root,
  ...
  @Deprecated
  @Nonnull
  public static List<GitHeavyCommit> commitsDetails(@Nonnull Project project,
                                                    @Nonnull FilePath path,
                                                    @Nullable SymbolicRefsI refs,
                                                    @Nonnull Collection<String> commitsIds) throws VcsException {
  ...
  @Nullable
  public static GitRevisionNumber getMergeBase(@Nonnull Project project,
                                               @Nonnull VirtualFile root,
                                               @Nonnull String first,
                                               @Nonnull String second) throws VcsException {
