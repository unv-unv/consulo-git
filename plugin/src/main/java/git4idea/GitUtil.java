...
public class GitUtil {
   ...
   */
  public static Map<VirtualFile, List<VirtualFile>> sortFilesByGitRoot(Collection<VirtualFile> virtualFiles,
                                                                       boolean ignoreNonGit) throws VcsException {
   ...
   */
  @Nonnull
  public static Map<VirtualFile, List<FilePath>> sortFilePathsByGitRoot(@Nonnull Collection<FilePath> files,
                                                                        boolean ignoreNonGit) throws VcsException {
  ...
  @Nullable
  public static GitRemoteBranch findRemoteBranch(@Nonnull GitRepository repository,
    ...
    return ContainerUtil.find(repository.getBranches().getRemoteBranches(), new Condition<GitRemoteBranch>() {
      ...
      public boolean value(GitRemoteBranch remoteBranch) {
        return remoteBranch.getRemote().equals(remote) && remoteBranch.getNameForRemoteOperations()
                                                                      .equals(GitBranchUtil.stripRefsPrefix(nameAtRemote));
      }
    });
  }

  @Nonnull
  public static GitRemoteBranch findOrCreateRemoteBranch(@Nonnull GitRepository repository,
   ...
   */
  @Nonnull
  public static Collection<String> getPathsDiffBetweenRefs(@Nonnull Git git,
                                                           @Nonnull GitRepository repository,
                                                           @Nonnull String beforeRef,
                                                           @Nonnull String afterRef) throws VcsException {
   ...
   */
  @Nonnull
  public static List<Change> findLocalChangesForPaths(@Nonnull Project project,
  ...
  public static void showPathsInDialog(@Nonnull Project project,
   ...
   */
  @Nonnull
  public static Collection<Change> findCorrespondentLocalChanges(@Nonnull ChangeListManager changeListManager,
