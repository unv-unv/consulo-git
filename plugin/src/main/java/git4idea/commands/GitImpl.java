...
public class GitImpl implements Git {
  ...
  @Override
  @Nonnull
  public Set<VirtualFile> untrackedFiles(@Nonnull Project project,
  ...
  @Nonnull
  @Override
  public GitCommandResult checkAttr(@Nonnull final GitRepository repository,
  ...
  @Override
  @Nonnull
  public GitCommandResult merge(@Nonnull GitRepository repository,
  ...
  @Nonnull
  @Override
  public GitCommandResult checkoutNewBranch(@Nonnull GitRepository repository,
  ...
  @Nonnull
  @Override
  public GitCommandResult branchDelete(@Nonnull GitRepository repository,
                                       @Nonnull String branchName,
                                       boolean force,
                                       @Nonnull GitLineHandlerListener... listeners) {
  ...
  @Nonnull
  @Override
  public GitCommandResult renameBranch(@Nonnull GitRepository repository,
  ...
  @Override
  @Nonnull
  public GitCommandResult reset(@Nonnull GitRepository repository,
  ...
  @Nonnull
  private static GitCommandResult reset(@Nonnull GitRepository repository,
  ...
  @Override
  @Nonnull
  public GitCommandResult fetch(@Nonnull final GitRepository repository,
                                @Nonnull final GitRemote remote,
                                @Nonnull final List<GitLineHandlerListener> listeners,
                                final String... params) {
    return runCommand(() ->
                      {
  ...
  @Nonnull
  @Override
  public GitCommandResult lsRemote(@Nonnull Project project,
  ...
  @Nonnull
  @Override
  public GitCommandResult rebase(@Nonnull GitRepository repository,
  ...
  @Nonnull
  private GitCommandResult rebaseResume(@Nonnull GitRepository repository,
  ...
  @Nonnull
  private GitCommandResult runWithEditor(@Nonnull Project project,
                                         @Nonnull VirtualFile root,
  ...
  @Nonnull
  protected GitInteractiveRebaseEditorHandler configureEditor(@Nonnull Project project,
                                                              @Nonnull VirtualFile root,
                                                              @Nonnull GitLineHandler handler,
                                                              boolean commitListAware) {
