...
public class SSHConfig {
     ...
     */
    private final static Set<String> ALLOWED_METHODS = new HashSet<>();
    ...
    public static SSHConfig load() throws IOException {
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                String argument = unquoteIfNeeded(parts[1]);
                ...
                if ("BatchMode".equalsIgnoreCase(keyword)) {
                    ...
                    List<String> list = parseList(argument);
    ...
    public static class Host {
        ...
        public int getNumberOfPasswordPrompts() {
            return notNull(myNumberOfPasswordPrompts);
        }
        ...
        public boolean supportsPasswordAuthentication() {
            return notNull(myPasswordAuthentication);
        }
        ...
        public boolean supportsPubkeyAuthentication() {
            return notNull(myPubkeyAuthentication);
        }
            ...
            if (myPreferredMethods == null) {
                myPreferredMethods = Collections
                    .unmodifiableList(Arrays.asList(
                        SSHMain.PUBLIC_KEY_METHOD,
                        SSHMain.KEYBOARD_INTERACTIVE_METHOD,
                        SSHMain.PASSWORD_METHOD
                    ));
            }
            if (myBatchMode == null) {
